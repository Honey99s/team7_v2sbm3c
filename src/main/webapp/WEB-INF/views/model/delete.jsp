...
<title>http://localhost:9092/model/delete.do?modelno=2</title>
...
<div class='title_line'>차종 > [<%=name %>]삭제</div>
<div id='panel_delete' style='padding: 10px 0px 10px 0px; background-color: #F9F9F9; width: 100%; text-align: center;'>
    <form name='frm_delete' id='frm_delete' method='post' action='./delete.do'>
      <input type="hidden" name="modelno" value="<%=modelno %>">
      
      <div class="msg_warning">차종을 삭제하면 복구 할 수 없습니다.</div>
      <label>차종 이름</label>: <%=name %>

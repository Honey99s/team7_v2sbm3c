...
<body>
  <form name="smsForm" action="./proc.do" method="post">
    ...
    이름 입력 <input type="text" name="cname" value="" autofocus="autofocus">예) 홍길동<br>
    <br>
    전화 번호 입력 <input type="text" name="tel" value="010-" autofocus="autofocus"> 예) 011-0112-1112 , '-' 포함해서 입력. <br>
    <br>
    아이디 입력 <input type="text" name="id" value="" autofocus="autofocus">예) user1@gmail.com<br>

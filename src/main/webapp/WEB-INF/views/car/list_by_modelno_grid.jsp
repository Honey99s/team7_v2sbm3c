...
<title>http://localhost:9092/car/list_all.do</title>
...
<c:import url="/menu/top.do" />
  ...
  <aside class="aside_right">
    ...
    <span class='menu_divide' >│</span>    
    <a href="./list_by_modelno.do?modelno=${param.modelno }&now_page=${param.now_page}&word=${param.word }">목록형</a>    
    <span class='menu_divide' >│</span>
    <a href="./list_by_modelno_grid.do?modelno=${param.modelno }&now_page=${param.now_page}&word=${param.word }">갤러리형</a>    
  </aside>
  ...
  <div style='width: 100%;'> <%-- 갤러리 Layout 시작 --%>
    <c:forEach var="carVO" items="${list }" varStatus="status">
      ...
      <div onclick="location.href='./read.do?carno=${carno}&word=${param.word }&now_page=${param.now_page == null ? 1 : param.now_page }&modelno=${param.modelno }'" 
        ...
        <c:choose> 
          <c:when test="${thumb1.endsWith('jpg') || thumb1.endsWith('png') || thumb1.endsWith('gif')}"> <%-- 이미지인지 검사 --%>
            ...
            <img src="/car/storage/${thumb1 }" style="width: 100%; height: 120px;">
          </c:when>
          <c:otherwise> <!-- 이미지가 없는 경우 기본 이미지 출력: /static/car/images/none1.png -->
            <IMG src="/car/images/none1.png" style="width: 100%; height: 120px;">
          </c:otherwise>
        </c:choose>
        ${title }

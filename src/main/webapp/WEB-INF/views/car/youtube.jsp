...
<DIV class='title_line'><A href="/car/list_by_modelno.do?modelno=${modelVO.modelno }" class="title_link">${modelVO.name }</A> > ${carVO.title } > Youtube 등록/수정/삭제</DIV>
...
<DIV class='content_body'>
  ...
  <FORM name='frm_youtube' method='POST' action='./youtube.do'>
    ...
    <div>
       ...
       <textarea name='youtube' class="form-control" rows="12" style='width: 100%;'>${carVO.youtube }</textarea>
    </div>
  ...
  <DIV style="text-align: center;">
      ...
      <IMG src='/car/images/youtube01.jpg' style='width: 60%;'><br><br>
      <IMG src='/car/images/youtube02.jpg' style='width: 60%;'><br>
  </DIV>

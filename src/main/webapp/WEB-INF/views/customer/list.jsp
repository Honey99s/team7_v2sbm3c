...
<c:import url="/menu/top.do" />
  ...
  <DIV class='title_line'>고객(마스터 전용)</DIV>
  ...
  <table class="table table-striped" style='width: 100%;'>
    ...
    <TR>
      <TD class='td_basic'>
        <c:choose>
          <c:when test="${grade >= 1 and grade <= 10}"><img src='/customer/images/admin.png' title="마스터" class="icon"></c:when>    
          <c:when test="${grade >= 11 and grade <= 20}"><img src='/customer/images/user.png' title="고객" class="icon"></c:when>
          <c:when test="${grade >= 30 and grade <= 39}"><img src='/customer/images/pause.png' title="정지 고객" class="icon"></c:when>
          <c:when test="${grade >= 40 and grade <= 49}"><img src='/customer/images/x.png' title="탈퇴 고객" class="icon"></c:when>
        </c:choose>  
      </TD>

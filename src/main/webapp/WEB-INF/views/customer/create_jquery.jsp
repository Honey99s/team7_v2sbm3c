...
<script type="text/javascript">
  ...
  function checkID() {
    ...
    if (id.value.trim().length == 0) {
      ...
      $.ajax({
        url: './checkID.do', // spring execute, http://localhost:9092/customer/checkID.do?id=user1@gmail.com
        type: 'get',  // post
...
<c:import url="/menu/top.do" />
  ...
  <DIV class='title_line'>고객 가입(*: 필수)</DIV>
  ...
  <form name='frm' id='frm' method='POST' action='./create.do' class="">
    ...
    <div class="form-group">
      <label>성명*:
        <input type='text' class="form-control form-control-sm" name='cname' id='cname' value='하정우' required="required" placeholder="성명">
      </label>

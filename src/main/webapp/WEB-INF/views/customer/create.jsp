...
<script type="text/javascript">
  ...
  function checkID() {
    ...
    if (id.value.trim().length == 0) {
      ...
      // 처리중 출력
      id_msg.innerHTML="<img src='/customer/images/ani04.gif' style='width: 5%;'>"; // static 기준
...
<c:import url="/menu/top.do" />
  ...
  <form name='frm' id='frm' method='POST' action='./create.do' class="">
    ...
    <div class="form-group">
      <label>성명*:
        <input type='text' class="form-control form-control-sm" name='cname' id='cname' value='김이박' required="required" placeholder="성명">
      </label>

...
<c:import url="/menu/top.do" />
  ...
  <DIV class='title_line'>마스터 로그인</DIV>
    ...
    <FORM name='frm' method='POST' action='./login.do'>
      ...
      <div class="form_input" style="margin-left: 15%;">
        ...
        <input type='text' class="form-control" name='id' id='id' required="required" 
                  style='width: 80%;' placeholder="아이디" autofocus="autofocus" value="${cookie.ck_master_id.value }">
        <label>   
      ...
      <div class="form_input" style="margin-left: 15%;">
        ...
        <input type='password' class="form-control" name='passwd' id='passwd' 
                  required="required" style='width: 80%;' placeholder="패스워드" value="${cookie.ck_master_passwd.value }">
        <label>

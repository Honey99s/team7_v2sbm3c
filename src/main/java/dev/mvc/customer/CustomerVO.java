...
public class CustomerVO {
    /*
     * customerno INT NOT NULL AUTO_INCREMENT, -- 회원 번호, 레코드를 구분하는 컬럼 id VARCHAR(20)
     * NOT NULL UNIQUE, -- 아이디, 중복 안됨, 레코드를 구분 passwd VARCHAR(20) NOT NULL, -- 패스워드,
     * 영숫자 조합 cname VARCHAR(30) NOT NULL, -- 성명, 한글 10자 저장 가능 tel VARCHAR(14) NOT
     * NULL, -- 전화번호 zipcode VARCHAR(5) NULL, -- 우편번호, 12345 address1 VARCHAR(80)
     * NULL, -- 주소 1 address2 VARCHAR(50) NULL, -- 주소 2 cdate DATETIME NOT NULL, --
